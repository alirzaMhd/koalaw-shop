...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (window.AOS) {
    ...
    document.querySelectorAll("[data-aos-duration]").forEach(e => e.setAttribute("data-aos-duration", "600"));
  }
  ...
  if (btt) {
    window.addEventListener("scroll", KUtils.throttle(() => {
  ...
  if (productGrid) {
    ...
    const items = [
      { d: "100", c: "skincare bestseller", t: "اکسیر درخشش طلایی", p: 480000, r: 4.8 },
      { d: "200", c: "makeup", t: "بوسه مخملی مات", p: 320000, r: 4.5 },
      { d: "300", c: "makeup", t: "پایه ابریشمی بی‌نقص", p: 420000, r: 4.9 },
      { d: "400", c: "fragrance bestseller", t: "راز نیمه‌شب", p: 780000, r: 4.7 }
    ];
    items.forEach(p => {
      const primary = p.c.split(" ")[0];
      const icon = ({ skincare: "shield", makeup: "pen-tool", fragrance: "wind" }[primary]) || "gift";
      const stars = '<i data-feather="star" class="w-4 h-4 fill-current"></i>'.repeat(Math.floor(p.r));
      productGrid.innerHTML += `
        <a href="#" class="product-card-v3 break-inside-avoid category-${primary}" data-aos="fade-up" data-aos-delay="${p.d}" data-category="${p.c}">
          ...
          <div class="card-image-wrapper">
            <img src="./src/assets/images/product.png" alt="${p.t}" class="card-image">
          </div>
  ...
  if (tGrid) {
    [
      { d: 100, i: "1438761681033-6461ffad8d80", t: "«اکسیر درخشش طلایی پوست من را کاملاً متحول کرده...»", n: "سوفیا چن", s: "خریدار تایید شده • ۳ ماه پیش" },
      { d: 200, i: "1494790108377-be9c29b29330", t: "«به عنوان یک میکاپ آرتیست... کرم پودر کوالا یک تغییر بزرگ است.»", n: "اِما رودریگز", s: "میکاپ آرتیست حرفه‌ای • ۱ ماه پیش" },
      { d: 300, i: "1507003211169-0a1dd7228f2d", t: "«عطر راز نیمه‌شب حالا عطر امضای من است...»", n: "مایکل پارک", s: "مشتری وفادار • ۲ هفته پیش" }
    ].forEach(t => {
      tGrid.innerHTML += `
