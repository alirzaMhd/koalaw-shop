...
export class AppError extends Error {
  ...
  constructor(message: string, httpStatus = 500, code = "INTERNAL_ERROR", expose = true, details?: any) {
    super(message);
    this.name = "AppError";
  ...
  // Helpers
  static badRequest(msg = "درخواست نامعتبر است.", code = "BAD_REQUEST", details?: any) {
