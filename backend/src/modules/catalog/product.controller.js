...
import { listProductsQuerySchema, createProductInputSchema as createProductSchema, updateProductInputSchema as updateProductSchema, addImageInputSchema as addImageSchema, updateImageInputSchema as updateImageSchema, addVariantInputSchema as addVariantSchema, updateVariantInputSchema as updateVariantSchema, addReviewInputSchema as addReviewSchema, listReviewsQuerySchema as listReviewsSchema, } from "./product.validators.js";
// Param schemas
...
function normalizeArrayParams(q) {
    const out = { ...q };
    const alias = [
...
class ProductController {
    ...
    // ------- Reviews (NEW) -------
    listReviewsById = async (req, res, next) => {
        try {
            const { id } = await productIdParamSchema.parseAsync(req.params);
    ...
    listReviewsBySlug = async (req, res, next) => {
        try {
            const { slug } = await productSlugParamSchema.parseAsync(req.params);
            const query = await listReviewsSchema.parseAsync(req.query ?? {});
    ...
    addReviewById = async (req, res, next) => {
        try {
            const { id } = await productIdParamSchema.parseAsync(req.params);
    ...
    addReviewBySlug = async (req, res, next) => {
        try {
            const { slug } = await productSlugParamSchema.parseAsync(req.params);
            const body = await addReviewSchema.parseAsync(req.body ?? {});
            const userId = req.user?.id || req.user?.sub || null;
