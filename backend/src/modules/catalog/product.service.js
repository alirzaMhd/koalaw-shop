...
function pickCoreProductData(input, brandId) {
  const data = {
    ...
    ...(typeof input.subtitle !== "undefined"
    ...
    ...(typeof input.description !== "undefined"
      ...
      : {}),
    ...(typeof input.ingredients !== "undefined"
      ? { ingredients: input.ingredients }
      : {}),
    ...(typeof input.howToUse !== "undefined"
      ? { howToUse: input.howToUse }
      : {}),
    ...(typeof input.price === "number" ? { price: input.price } : {}),
    ...(typeof input.compareAtPrice !== "undefined"
    ...
    ...(typeof input.isFeatured === "boolean"
      ...
      : {}),
    ...(typeof input.isSpecialProduct === "boolean"
      ? { isSpecialProduct: input.isSpecialProduct }
      : {}),
    ...(typeof input.isActive === "boolean"
      ? { isActive: input.isActive }
      : {}),
    ...(typeof input.heroImageUrl !== "undefined"
...
function includeForList(opts) {
  return {
    brand: true,
    colorTheme: true,
    images: opts?.includeImages ? { orderBy: { position: "asc" } } : undefined,
...
class ProductService {
  ...
  async list(query) {
    const { page, perPage, sort, includeImages, includeVariants, ...rest } =
      query;
  ...
  async update(id, input) {
    ...
    const coreData = {
      ...pickCoreProductData({ ...input, slug: slugUpdate }, brandId),
    };
  ...
  async updateVariant(productId, variantId, input /* UpdateVariantInput */) {
    ...
    const row = await prisma.productVariant.update({
      ...
      data: {
        ...
        colorName:
          typeof input.colorName !== "undefined" ? input.colorName : undefined,
        colorHexCode:
          typeof input.colorHexCode !== "undefined"
            ? input.colorHexCode
            : undefined,
        isActive:
  ...
  async getFilterOptions() {
    ...
    const brandCountMap = new Map(
      brandCounts.map((b) => [b.brandId, b._count._all])
    );
