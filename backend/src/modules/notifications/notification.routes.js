...
notificationRouter.post(
  "/orders/:orderId/payments/:paymentId/receipt",
  authGuard,
  requireAdmin,
  notificationController.sendPaymentReceipt
);
notificationRouter.post(
  "/orders/:orderId/shipping",
  authGuard,
  requireAdmin,
  notificationController.sendShippingUpdate
);
...
notificationRouter.post(
  ...
  authGuard,
  requireAdmin,
  notificationController.bindDefaultHandlers
);
