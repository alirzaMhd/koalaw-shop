...
import { registerSchema, loginSchema, refreshTokenSchema, logoutSchema, verifyEmailSchema, resendVerificationSchema, 
// NEW:
forgotPasswordSchema, resetPasswordSchema, } from "./auth.validators.js";
...
const COOKIE_SECURE = typeof env.COOKIE_SECURE === "string"
